...
QSqlQueryModel * Reservation::afficherAnnulation()
{
    QSqlQueryModel * model= new QSqlQueryModel();

  model->setQuery("select ROUND(AVG) as statistiques_annulation from réservation");
  model->setHeaderData(0, Qt::Horizontal, QObject::tr("statistiques_annulation"));
